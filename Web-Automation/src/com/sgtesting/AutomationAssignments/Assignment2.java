...
public class Assignment2 {
	...
	private static void modifyUser()
	{
		try
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.name("firstName")).sendKeys("SandySandesh");
			oBrowser.findElement(By.name("lastName")).clear();
			Thread.sleep(2000);
			oBrowser.findElement(By.name("lastName")).sendKeys("Upparahalli");
	...
	private static void deleteUser()
	{
		try
		{
			oBrowser.findElement(By.xpath("//span[text()='TumkurUpparahalli, SandySandySndesh']")).click();
			Thread.sleep(3000);
